...
def save_checkpoint(state, save_dir, is_best, exp_name, model_name):
    """
    ...
    checkpoint_path = save_dir + '/' + str(exp_name) + str(model_name) + '_checkpoint.pth.tar'
    if not os.path.exists(checkpoint_path):
        os.makedirs(save_dir)
    torch.save(state, checkpoint_path)
    if is_best:
        best_checkpoint_path = save_dir + '/' + str(exp_name) + str(model_name) + '_best_model.pth'
