...
def load_data_HDF(image_file, label_file):
    ...
    # data_all, label = data_all[:500,:500,:], label[:500,:500]
...
def load_data(image_file, label_file):
    ...
    # data_key, label_key = 'data', 'mask_test'
...
train_data_file = './HyperspecVNIR_Chikusei_20140729.mat'
train_label_file = './HyperspecVNIR_Chikusei_20140729_Ground_Truth.mat'

patch_length = 4
imdb = getDataAndLabels(train_data_file, train_label_file, patch_length)

with open('datasets/houston_imdb_pt4.pickle', 'wb') as handle:
