...
config['target_data'] = 'paviaU/paviaU.mat'
config['target_data_gt'] = 'paviaU/paviaU_gt.mat'
...
train_opt['tar_input_dim'] = 103
train_opt['n_dim'] = 100
train_opt['class_num'] = 9
train_opt['shot_num_per_class'] = 1
train_opt['query_num_per_class'] = 19

train_opt['test_class_num'] = 9
